...
public class EducationController {
    ...
    public ResponseEntity<Void> saveEducation(@RequestBody EducationDTO educationDTO, @AuthenticationPrincipal CustomUserDetails customUserDetails){
    ...
    public ResponseEntity<Void> updateEducation(@PathVariable Long educationId, @RequestBody EducationDTO educationDTO){
